...
//  initiate maintain_arr
 ...
 if (2*result[0]>result[1])
   ...
   {
     fprintf(fp, "\t\t\t\t\t\t\t\t\t\t\t\t\t\tgen_output/42_AccOne0_AccTwo1_AccThr1_Aff1_1450.c Succeed \n");
     fprintf(fp_res, "1");
   } else {
     fprintf(fp, "\t\t\t\t\t\t\t\t\t\t\t\t\t\tgen_output/42_AccOne0_AccTwo1_AccThr1_Aff1_1450.c Fails \n");
     fprintf(fp_res, "0");
   }
  fclose(fp);  
  fclose(fp_res);  
